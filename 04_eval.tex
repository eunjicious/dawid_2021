...
Fig.\ref{fig_perf_iops} shows the IOPS of FIFO-SSD(F) and DAWID-SSD(D) with different 
size of write buffers when a protected ratio is changing. Fig.~\ref{fig_perf_wt}
