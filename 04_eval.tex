...
\begin{figure*}[!t]
    \centering{}
	\subfloat[Random] { 
	    \includegraphics[width=0.28\textwidth]{expr/micro_rslt_220525/wt/RAND_1.eps}
	} 
	\subfloat[JESD] { 
	    \includegraphics[width=0.28\textwidth]{expr/micro_rslt_220525/wt/JESD_1.eps}
	}
	\subfloat[TPC-C] { 
	    \includegraphics[width=0.28\textwidth]{expr/macro_rslt_220525/wt/OLTP_40.eps}
	}
