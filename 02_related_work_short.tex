...
requirements by making use of elastic journaling. Spartan-SSD logs the mapping
...
Although Spartan-SSD also reduces translation-related writes under capacitance
constratins, it not only have double write for maping information updates, but
also it essentially increases a recovery time, which could be highly harmful
