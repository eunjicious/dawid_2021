...
while using fraction of the capacitors compared to the state-of-the-art designs. 
We implement our design in FEMU %, an open-source SSD development framework,
and demonstrate that \ours{} delivers up to 1.4x higher IOPS and 49\% less write amplification 
