...
\begin{figure}[t!]
    \centering{}
	\subfloat[JESD] { 
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/JESD_FIFO.eps}
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/JESD_DAWID.eps}
	} \\
	\subfloat[OLTP]{ 
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/OLTP_FIFO.eps}
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/OLTP_DAWID.eps}
	} \\
	\subfloat[Linkbench]{ 
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/JESD_FIFO.eps}
    	\includegraphics[width=0.2\textwidth]{expr/hitMap/JESD_FIFO.eps}
